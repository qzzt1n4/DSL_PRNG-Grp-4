...
HD_PWD='E:/Digital System FPGA/DSL_1D_project_Normal/DSL_1D_project_Normal.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Normal_code.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Normal_code.tcl -notrace
