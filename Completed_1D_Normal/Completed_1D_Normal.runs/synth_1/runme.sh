...
HD_PWD='E:/Digital System FPGA/DSL_1D_project_Normal/DSL_1D_project_Normal.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Normal_code.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Normal_code.tcl
